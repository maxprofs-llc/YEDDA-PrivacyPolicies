...
class Example(Frame):
    def __init__(self, parent):
        ...
        self.pressCommand = {'a':"Collect Personal Information",
                             'b':"Not Collect Personal Information",
                             'c':"Data Retention Period",
                             'd':"The Purposes Of Processing",
                             'e':"The Contact Details Of The Controller",
                             'f':"The Contact Details Of The Data Protection Officer",
                             'g':"Access Personal Data",
                             'h':"Rectification Or Erasure Of Personal Data",
